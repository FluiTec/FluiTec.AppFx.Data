...
namespace FluiTec.AppFx.Data.Dynamic
{
    ...
    public class DataMigrationException : Exception
    {
        ...
        public DataMigrationException(long currentVersion, long maximumVersion, Type dataServiceType) : base(
            $"\"{dataServiceType.Name}\" needs version {maximumVersion} but the database only supplies version {currentVersion}. Please migrate manually or enable AutoMigrate")
        {
