        ...
        public override void Display(IConsoleItem parent)
        {
            ...
            if (Info.Version > Migrator.CurrentVersion)
            {
                AnsiConsole.MarkupLine(
                    $">> Applying this migration will update the db version to {Presenter.HighlightText("increase")}");
            ...
            {
                AnsiConsole.MarkupLine(
                    $">> Applying this migration will update the db version to {Presenter.ErrorText("decrease")}");
