...
public abstract class
    ConfigurableLiteDbDataProvider<TDataService, TUnitOfWork> : LiteDbDataProvider<TDataService, TUnitOfWork>
    ...
    where TUnitOfWork : IUnitOfWork
{
    ...
    protected ConfigurableLiteDbDataProvider(Func<LiteDatabase> configureDelegate, TDataService dataService,
        DataOptions options) : base(dataService, options)
    {
