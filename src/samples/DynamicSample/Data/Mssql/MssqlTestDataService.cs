...
namespace DynamicSample.Data.Mssql
{
    ...
    public class MssqlTestDataService : DapperDataService<MssqlTestUnitOfWork>, ITestDataService
    {
        /// <summary>   Constructor. </summary>
        /// <param name="dapperServiceOptions"> Options for controlling the dapper service. </param>
        /// <param name="loggerFactory">        The logger factory. </param>
        public MssqlTestDataService(IDapperServiceOptions dapperServiceOptions, ILoggerFactory loggerFactory) : base(dapperServiceOptions, loggerFactory)
        {
        }
        ...
        public override MssqlTestUnitOfWork BeginUnitOfWork()
        {
            return new MssqlTestUnitOfWork(this, LoggerFactory?.CreateLogger<IUnitOfWork>());
        }
        ...
        /// <returns>   An IUnitOfWork. </returns>
        public override MssqlTestUnitOfWork BeginUnitOfWork(IUnitOfWork other)
        {
            ...
            return new MssqlTestUnitOfWork((DapperUnitOfWork)other, this, LoggerFactory?.CreateLogger<IUnitOfWork>());
        }
