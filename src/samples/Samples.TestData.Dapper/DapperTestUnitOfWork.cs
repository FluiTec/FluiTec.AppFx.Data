...
public class DapperTestUnitOfWork : DapperUnitOfWork, ITestUnitOfWork
{
    ...
    public DapperTestUnitOfWork(TransactionOptions transactionOptions, ITestDataService dataService, IDapperDataProvider dataProvider) 
    ...
    /// <param name="dataService">      The data service. </param>
    /// <param name="dataProvider">     The data provider. </param>
    public DapperTestUnitOfWork(IUnitOfWork parentUnitOfWork, ITestDataService dataService, IDapperDataProvider dataProvider) 
