using System;
using Cli.Sample.Data.Dapper;
using Cli.Sample.Data.Schema;
...
namespace Cli.Sample.Data.Mysql
{
    ...
    public class MysqlTestDataService : DapperDataService<DapperTestUnitOfWork>, ITestDataService
    {
        ...
        /// <param name="dapperServiceOptions"> Options for controlling the dapper service. </param>
        /// <param name="loggerFactory">        The logger factory. </param>
        public MysqlTestDataService(IOptionsMonitor<IDapperServiceOptions> dapperServiceOptions,
