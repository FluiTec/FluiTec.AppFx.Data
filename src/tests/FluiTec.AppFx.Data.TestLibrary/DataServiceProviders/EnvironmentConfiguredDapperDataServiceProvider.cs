...
namespace FluiTec.AppFx.Data.TestLibrary.DataServiceProviders
{
    ...
    public abstract class EnvironmentConfiguredDapperDataServiceProvider<TDataService, TUnitOfWork> : DapperDataServiceProvider<TDataService, TUnitOfWork>
        ...
        where TUnitOfWork : IUnitOfWork
    {
        ...
        /// </value>
        public bool EnvironmentConfigured => !string.IsNullOrWhiteSpace(Environment.GetEnvironmentVariable(VariableName));
    }
}