...
namespace FluiTec.AppFx.Data.TestLibrary.Repositories
{
    ...
    /// </summary>
    public class NMemoryDateTimeDummyRepository : NMemoryWritableKeyTableDataRepository<DateTimeDummyEntity, int>,
        IDateTimeDummyRepository
    {
        ...
        public NMemoryDateTimeDummyRepository(NMemoryUnitOfWork unitOfWork, ILogger<IRepository> logger) : base(
            unitOfWork, logger)
        {
        }
    }
