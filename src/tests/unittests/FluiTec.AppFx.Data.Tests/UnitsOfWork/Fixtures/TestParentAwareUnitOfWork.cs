...
public class TestParentAwareUnitOfWork : ParentAwareUnitOfWork
{
    ...
    public TestParentAwareUnitOfWork(ILogger<IUnitOfWork>? logger, TransactionOptions transactionOptions) : base(logger,
        transactionOptions)
    {
    }
    ...
    public TestParentAwareUnitOfWork(ILogger<IUnitOfWork>? logger, IUnitOfWork parentUnitOfWork) : base(logger,
        parentUnitOfWork)
    {
    }
