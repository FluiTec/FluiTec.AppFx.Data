...
namespace FluiTec.AppFx.Data.Sql.Tests.Adapters
{
    ...
    public class PostgreSqlAdapterTest : SqlAdapterTest
    {
        ...
        protected override string GetExpectedSelectAllStatement(Type entityType)
        {
            ...
            if (entityType == typeof(MultiKeyDummy)) return "SELECT \"Id\", \"MyKey\" FROM \"public\".\"MultiKeyDummy\"";
            throw new NotImplementedException();
        }
        ...
        {
            if (entityType == typeof(Dummy)) return "SELECT \"Id\", \"Name\" FROM \"public\".\"Dummy\" WHERE \"Id\" = @Id";
            if (entityType == typeof(RenamedDummy)) return "SELECT \"UId\", \"Name\" FROM \"public\".\"RenamedDummy\" WHERE \"UId\" = @UId";
            if (entityType == typeof(MultiKeyDummy)) return "SELECT \"Id\", \"MyKey\" FROM \"public\".\"MultiKeyDummy\" WHERE \"Id\" = @Id AND \"MyKey\" = @MyKey";
            throw new NotImplementedException();
        }
        ...
        {
            if (entityType == typeof(Dummy)) return "SELECT \"Id\", \"Name\" FROM \"public\".\"Dummy\" WHERE \"Name\" = @Name";
            if (entityType == typeof(RenamedDummy)) return "SELECT \"UId\", \"Name\" FROM \"public\".\"RenamedDummy\" WHERE \"Name\" = @Name";
            if (entityType == typeof(MultiKeyDummy)) return "SELECT \"Id\", \"MyKey\" FROM \"public\".\"MultiKeyDummy\" WHERE \"MyKey\" = @MyKey";
            throw new NotImplementedException();
        }
        ...
        {
            if (entityType == typeof(Dummy)) return "SELECT \"Id\", \"Name\" FROM \"public\".\"Dummy\" WHERE \"Name\" = ANY(@Names)";
            if (entityType == typeof(RenamedDummy)) return "SELECT \"UId\", \"Name\" FROM \"public\".\"RenamedDummy\" WHERE \"Name\" = ANY(@Names)";
            if (entityType == typeof(MultiKeyDummy)) return "SELECT \"Id\", \"MyKey\" FROM \"public\".\"MultiKeyDummy\" WHERE \"MyKey\" = ANY(@Keys)";
            throw new NotImplementedException();
        }
        ...
        {
            if (entityType == typeof(Dummy)) return "SELECT \"Id\", \"Name\" FROM \"public\".\"Dummy\" WHERE \"Id\" = @Id AND \"Name\" = @Name";
            if (entityType == typeof(RenamedDummy)) return "SELECT \"UId\", \"Name\" FROM \"public\".\"RenamedDummy\" WHERE \"UId\" = @UId AND \"Name\" = @Name";
            if (entityType == typeof(MultiKeyDummy)) return "SELECT \"Id\", \"MyKey\" FROM \"public\".\"MultiKeyDummy\" WHERE \"Id\" = @Id AND \"MyKey\" = @MyKey";
            throw new NotImplementedException();
        }
        ...
        {
            if (entityType == typeof(Dummy)) return "INSERT INTO \"public\".\"Dummy\" (\"Id\", \"Name\") VALUES (@Id, @Name)";
            if (entityType == typeof(RenamedDummy)) return "INSERT INTO \"public\".\"RenamedDummy\" (\"UId\", \"Name\") VALUES (@UId, @Name)";
            if (entityType == typeof(MultiKeyDummy)) return "INSERT INTO \"public\".\"MultiKeyDummy\" (\"Id\", \"MyKey\") VALUES (@Id, @MyKey)";
            throw new NotImplementedException();
        }
        ...
        {
            if (entityType == typeof(Dummy)) return "INSERT INTO \"public\".\"Dummy\" (\"Name\") VALUES (@Name) RETURNING \"Id\"";
            if (entityType == typeof(RenamedDummy)) return "INSERT INTO \"public\".\"RenamedDummy\" (\"Name\") VALUES (@Name) RETURNING \"UId\"";
            throw new NotImplementedException();
        }
        ...
        protected override string GetExpectedInsertMultipleStatement(Type entityType)
        {
            ...
            if (entityType == typeof(RenamedDummy)) return "INSERT INTO \"public\".\"RenamedDummy\" (\"Name\") VALUES (@Name)";
            if (entityType == typeof(MultiKeyDummy)) return "INSERT INTO \"public\".\"MultiKeyDummy\" (\"Id\", \"MyKey\") VALUES (@Id, @MyKey)";
            throw new NotImplementedException();
        }
        ...
        {
            if (entityType == typeof(Dummy)) return "UPDATE \"public\".\"Dummy\" SET \"Name\" = @Name WHERE \"Id\" = @Id";
            if (entityType == typeof(RenamedDummy)) return "UPDATE \"public\".\"RenamedDummy\" SET \"Name\" = @Name WHERE \"UId\" = @UId";
            if (entityType == typeof(MultiKeyDummy)) return "UPDATE \"public\".\"MultiKeyDummy\" SET \"Id\" = @Id, \"MyKey\" = @MyKey WHERE \"Id\" = @Id AND \"MyKey\" = @MyKey";
            throw new NotImplementedException();
        }
        ...
        protected override string GetExpectedDeleteStatement(Type entityType)
        {
            ...
            if (entityType == typeof(RenamedDummy)) return "DELETE FROM \"public\".\"RenamedDummy\" WHERE \"UId\" = @UId";
            if (entityType == typeof(MultiKeyDummy)) return "DELETE FROM \"public\".\"MultiKeyDummy\" WHERE \"Id\" = @Id AND \"MyKey\" = @MyKey";
            throw new NotImplementedException();
        }
        ...
        protected override string GetExpectedDeleteByStatement(Type entityType, string filterProperty)
        {
            ...
            if (entityType == typeof(RenamedDummy)) return "DELETE FROM \"public\".\"RenamedDummy\" WHERE \"Name\" = @Name";
            if (entityType == typeof(MultiKeyDummy)) return "DELETE FROM \"public\".\"MultiKeyDummy\" WHERE \"MyKey\" = @MyKey";
            throw new NotImplementedException();
        }
