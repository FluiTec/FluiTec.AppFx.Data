...
namespace FluiTec.AppFx.Data.Sql.Tests.Adapters
{
    ...
    public class SqLiteAdapterTest : SqlAdapterTest
    {
        ...
        {
            if (entityType == typeof(Dummy)) return "INSERT INTO Dummy (Name) VALUES (@Name);SELECT last_insert_rowid() Id";
            if (entityType == typeof(RenamedDummy)) return "INSERT INTO RenamedDummy (Name) VALUES (@Name);SELECT last_insert_rowid() UId";
            throw new NotImplementedException();
        }
