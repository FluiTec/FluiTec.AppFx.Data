...
namespace FluiTec.AppFx.Data.Sql.Tests.Adapters
{
    ...
    public class MicrosoftSqlAdapterTest : SqlAdapterTest
    {
        ...
        {
            if (entityType == typeof(Dummy)) return "SELECT [Id], [Name] FROM [dbo].[Dummy]";
            if (entityType == typeof(RenamedDummy)) return "SELECT [UId], [Name] FROM [dbo].[RenamedDummy]";
            if (entityType == typeof(MultiKeyDummy)) return "SELECT [Id], [MyKey] FROM [dbo].[MultiKeyDummy]";
            throw new NotImplementedException();
        }
        ...
        {
            if (entityType == typeof(Dummy)) return "DELETE FROM [dbo].[Dummy] WHERE [Name] = @Name";
            if (entityType == typeof(RenamedDummy)) return "DELETE FROM [dbo].[RenamedDummy] WHERE [Name] = @Name";
            if (entityType == typeof(MultiKeyDummy)) return "DELETE FROM [dbo].[MultiKeyDummy] WHERE [MyKey] = @MyKey";
            throw new NotImplementedException();
        }
        ...
        {
            if (entityType == typeof(Dummy)) return "[dbo].[Dummy]";
            if (entityType == typeof(RenamedDummy)) return "[dbo].[RenamedDummy]";
            if (entityType == typeof(MultiKeyDummy)) return "[dbo].[MultiKeyDummy]";
            throw new NotImplementedException();
        }
